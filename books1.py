#NO CONTENT_LAYOUT NA PO AH SO MAIN_LAYOUT ANG GAGAMITIN import sys #import requests from PySide6.QtCore import Qt, QSize from PySide6.QtGui import QFont, QIcon, QPixmap from PySide6.QtWidgets import ( QApplication, QWidget, QVBoxLayout, QPushButton, QHBoxLayout, QLabel, QSizePolicy
#DRAFT PA PLS DONT USE THIS PA EWAN KO PURO ERROR HUHUHU IMMA CRY 
...
from PySide6.QtWidgets import (
    ...
    QTextEdit, QMessageBox, QFormLayout, QDialog, QListWidget,
    QListWidgetItem
)
...
class BookEditView(QWidget):
    ...
    def handle_navigation(self, page_name):
        if self.parent_window.main_window:
            self.parent_window.main_window.navigate_to_page(page_name)
    ...
    def init_ui(self):
        ...
        header_layout = QHBoxLayout()
                ...
                # Create navigation sidebar with callback
        self.navbar = NavigationSidebar(on_nav_click=self.handle_navigation)
        
        # Set current page as active
        self.navbar.set_active_page("books")
...
class BooksManagement(QWidget):
    def __init__(self, main_window=None):
        ...
        # Set up the main layout with sidebar
    ...
    def setup_main_layout(self):
        """Set up the main layout with navigation sidebar"""
        ...
        self.navigation_sidebar = NavigationSidebar(self.main_window)
        self.navigation_sidebar.setFixedWidth(280)  # Fixed width for sidebar
        
        # Create content area
        self.content_area = QWidget()
        self.content_area.setStyleSheet("background-color: #f1efe3;")  # Match your background color
        
        # Content layout for switching between views
        ...
        # Set stretch factors to make content area expandable
        main_layout.setStretchFactor(self.navigation_sidebar, 0)
    ...
    def open_book_edit(self, book_data):
        ...
        self.main_layout.addWidget(self.book_edit_view)
    ...
    def show_books_view(self):
        ...
        self.populate_books()
        self.main_layout.addWidget(self.main_books_view)
        self.current_view = "books"
